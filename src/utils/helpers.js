...
export const getMoment = (locationName) => {
	...
	// STEP 1-5：將當前時間以 "2019-10-08" 的時間格式呈現
	...
	// STEP 1-9：若當前時間介於日出和日落中間，則表示為白天，否則為晚上
	return sunriseTimestamp <= nowTimeStamp && nowTimeStamp <= sunsetTimestamp
		? 'day'
		: 'night';
}
//step 1 : add availableLocations data
...
//step 2 : create findLocation function
